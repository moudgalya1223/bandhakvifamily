  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-amber-200/70 dark:border-slate-800 shadow-sm space-y-4 hover:shadow-md transition">
          <div className="w-12 h-12 rounded-2xl bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-400 flex items-center justify-center font-bold text-xl">
            <Sunrise className="w-6 h-6 text-amber-700 dark:text-amber-400" />
          </div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">Rishi Mudgala & Virtues</h3>
          <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            The Moudgalya Gotra traces its lineage to <strong className="dark:text-amber-300">Maharshi Mudgala</strong>, the Vedic sage revered in the <em>Rigveda</em>, <em>Mahabharata (Vana Parva)</em>, and <em>Puranas</em>. Known for his intense spiritual penance (*tapas*), supreme detachment (*vairagya*), and generous hospitality (*dharma*), Maharshi Mudgala earned the rare honor of ascending directly to heavenly realms in his mortal body.
          </p>
        </div>

        {/* Card 2: Rigveda Hymns */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-amber-200/70 dark:border-slate-800 shadow-sm space-y-4 hover:shadow-md transition">
          <div className="w-12 h-12 rounded-2xl bg-orange-100 dark:bg-orange-950/60 text-orange-800 dark:text-orange-400 flex items-center justify-center font-bold text-xl">
            <Scroll className="w-6 h-6 text-orange-700 dark:text-orange-400" />
          </div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">Rigvedic Hymns (Mandala X)</h3>
          <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-amber-200/70 dark:border-slate-800 shadow-sm space-y-4 hover:shadow-md transition">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">Tri-Rishi Pravara</h3>
          <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            The sacred Pravara recited by descendants of Moudgalya Gotra during Vedic rituals invokes three illustrious Rishis:
            <strong className="block mt-2 text-amber-900 dark:text-amber-300 font-semibold">1. Maharshi Angirasa</strong>
            <strong className="block text-amber-900 dark:text-amber-300 font-semibold">2. Maharshi Bharmyasva</strong>
            <strong className="block text-amber-900 dark:text-amber-300 font-semibold">3. Maharshi Moudgalya</strong>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-amber-200/80 dark:border-slate-800 shadow-sm space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-2xl font-extrabold text-slate-900 dark:text-slate-100">Revered Ancestral Rishis</h3>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl bg-gradient-to-b from-amber-50 to-orange-50/50 dark:from-slate-800 dark:to-slate-800/80 p-6 border border-amber-200/80 dark:border-slate-700 text-center space-y-3">
            ...
            <h4 className="font-bold text-slate-900 dark:text-slate-100 text-lg">Maharshi Angirasa</h4>
            <p className="text-xs text-amber-800 dark:text-amber-400 font-semibold uppercase tracking-wider">
          ...
          <div className="rounded-2xl bg-gradient-to-b from-amber-50 to-orange-50/50 dark:from-slate-800 dark:to-slate-800/80 p-6 border border-amber-200/80 dark:border-slate-700 text-center space-y-3">
            ...
            <h4 className="font-bold text-slate-900 dark:text-slate-100 text-lg">Maharshi Bharmyasva</h4>
            <p className="text-xs text-amber-800 dark:text-amber-400 font-semibold uppercase tracking-wider">
              Panchala Vedic Seer
            </p>
            <p className="text-slate-600 dark:text-slate-300 text-xs leading-relaxed">
      ...
      <div className="bg-amber-500/10 dark:bg-amber-950/40 rounded-3xl p-8 border border-amber-200/80 dark:border-amber-800/60 space-y-4">
        <h3 className="text-xl font-bold text-amber-950 dark:text-amber-300 flex items-center space-x-2">
